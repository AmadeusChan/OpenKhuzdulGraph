...
#define NUM_COUNTING_PATTERNS 2
#define ENABLE_COMPUTE_FUSION

int multiplicities[] = {1,2};
                        ...
                        case 2:
                            {
                                ...
                                VertexId * cached_ptx_1 = (VertexId*) engine->alloc_thread_local_scratchpad_buffer(context, prefix_0.get_num_vertices() * sizeof(VertexId));
                                VertexSet prefix_1(cached_ptx_1, 0);
                                VertexId * cached_ptx_2 = (VertexId*) engine->alloc_thread_local_scratchpad_buffer(context, prefix_0.get_num_vertices() * sizeof(VertexId));
                                ...
                                if (true && v_0 < v_1) {
                                    ...
                                    counts[0]->add(context, local_counter);
                                }
                                if (true) {
                                    prefix_0.subtracted_by(&nbrs, &prefix_2);
                                    EdgeId local_counter = 0;
                                    ...
                                    counts[1]->add(context, local_counter);
                                }
